<x-app-layout>
    ...
    <div class="space-y-4">
        ...
        <form method="POST"
              action="{{ route('operations.clients.update', $client->id) }}"
              class="space-y-4">
            @csrf
            @method('PUT')
                    ...
                    <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
                        <div class="min-w-0">
                            <div class="flex flex-wrap items-center gap-2">
                                <a href="{{ route('operations.clients.show', $client->id) }}"
                            ...
                            <p class="mt-2 text-xs sm:text-sm text-slate-300 max-w-3xl leading-relaxed">
                                Update client identity, contact details, business type, and address.
                            </p>
                        </div>
                ...
                <div class="2xl:col-span-8 space-y-4">
                    ...
                    <div class="rounded-[1.7rem] bg-white/85 backdrop-blur-xl border border-slate-200 shadow-sm overflow-hidden">
                        <div class="px-4 sm:px-5 py-4 border-b border-slate-100">
                            ...
                            <p class="text-xs sm:text-sm text-slate-500 mt-1">
                                Main information used to identify this client.
                            </p>
                        </div>
                    ...
                    <div class="rounded-[1.7rem] bg-white/85 backdrop-blur-xl border border-slate-200 shadow-sm overflow-hidden">
                        <div class="px-4 sm:px-5 py-4 border-b border-slate-100">
                            ...
                            <p class="text-xs sm:text-sm text-slate-500 mt-1">
                                Main communication channels and address.
                            </p>
                        </div>
                        ...
                        <div class="p-4 sm:p-5 space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="address"
                                          ...
                                          rows="4"
                                          oninput="updateClientPreview()"
                                          class="w-full rounded-2xl border-slate-200 bg-slate-50 focus:bg-white focus:border-blue-500 focus:ring-blue-500 px-4 py-3 text-sm text-slate-700 resize-none">{{ old('address', $client->address) }}</textarea>
                            </div>
                        </div>
                    </div>
